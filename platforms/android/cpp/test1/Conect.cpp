...
int i = 0;
double dados[6071], tempos[6071];

const char* Conect::main_processamentoEMG()
{
  char resultado[256];
 ...
 double digimon; 
 digimon =  processamentoEMG(dados, tempos, ContagemEntrePicos_data, ContagemEntrePicos_size,
...
const void Conect::add_dado(double dado, double tempo){
  dados[i] = dado;
  tempos[i] = tempo;
